...
const positionsDupSource = new Float32Array(buffer.duplicate(positions, 3, false))
...
const uniforms = {
  ...
  view: () => {
    if(!camera) return mat4.identity(mat4.create())
    return camera.view()
  },
...
export const Line = () => {
  ...
  React.useEffect(() => {
    ...
    camera = createCamera(canvasRef.current)
